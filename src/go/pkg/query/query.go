...
func RenderTCETable(records []TCERecord) string {
	...
	for _, record := range records {
		...
		html.WriteString(fmt.Sprintf(`<td class="col4">%.6f</td>`, display.Period))
		html.WriteString(fmt.Sprintf(`<td class="col5">%.1f</td>`, display.Epoch))
		html.WriteString(fmt.Sprintf(`<td class="col6">%.3f</td>`, display.Duration))
		html.WriteString(fmt.Sprintf(`<td class="col7">%.4f</td>`, display.PlanetRadius))
		html.WriteString(fmt.Sprintf(`<td class="col8">%.4f</td>`, display.Depth*100))
		html.WriteString(fmt.Sprintf(`<td class="col9">%.3f</td>`, display.ImpactB))
